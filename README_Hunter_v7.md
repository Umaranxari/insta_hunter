...
1. **Clone or download the Hunter_v7 files**
...
1. **Basic Filters**: Follower/post count limits
2. **Geographic Filters**: USA location verification
3. **Activity Filters**: Active story requirement
4. **Quality Filters**: Engagement rate analysis
5. **Content Filters**: Bio keyword analysis
6. **Commercial Filters**: Promotional content detection
7. **Verification Filters**: Excludes verified accounts (as configured)
...
3. Ensure proper configuration setup
